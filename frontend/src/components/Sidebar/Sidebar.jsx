    ...
    <aside className="w-64 bg-gray-50 border-r border-gray-200 dark:bg-gray-950 dark:border-gray-800 flex flex-col h-[calc(100vh-4rem)]">
      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-800 space-y-3">
        <button
          ...
          className="w-full flex items-center justify-center px-4 py-2 text-xs font-semibold text-red-600 hover:bg-red-50 dark:hover:bg-red-955/20 border border-red-200 dark:border-red-900 rounded-xl transition-colors"
        >
          {/* Sign Out Icon */}
